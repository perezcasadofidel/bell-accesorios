...
export const usePrevNextButtons = (
  ...
  useEffect(() => {
    ...
    const handleSelect = () => {
      onSelect(emblaApi);      // this may call setState
    };

    // first invocation – run *after* the effect has finished
    const id = window.setTimeout(handleSelect, 0);    // or requestAnimationFrame
